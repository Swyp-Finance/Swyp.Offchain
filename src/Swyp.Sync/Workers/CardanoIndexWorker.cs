...
) : BackgroundService
{
    ...
    private readonly IDbContextFactory<SwypDbContext> _dbContextFactory = dbContextFactory;
    ...
    private SwypDbContext DbContext { get; set; } = null!;
